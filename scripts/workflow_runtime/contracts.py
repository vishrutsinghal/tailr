...
SCHEMA_BY_TYPE = {
    ...
    "tailtrail-workflow-enterprise-access-review": "workflow-enterprise-access-review.schema.json",
    "tailtrail-workflow-enterprise-support-bundle": "workflow-enterprise-support-bundle.schema.json",
    "tailtrail-workflow-enterprise-support-bundle-verification": "workflow-enterprise-support-bundle-verification.schema.json",
