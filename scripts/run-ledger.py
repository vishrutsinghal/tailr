...
EVENT_TYPES.update({"debug_intake_recorded", "debug_reproduction_drafted", "debug_reproduction_approved", "debug_reproduction_rejected", "debug_hypothesis_added", "debug_experiment_recorded", "debug_investigation_blocked", "debug_replan_approved", "debug_root_cause_proven", "debug_correction_proposed", "debug_correction_approved", "debug_completion_report_created"})
