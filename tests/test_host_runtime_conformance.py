...
def make_receipt(root: Path, host: str, scenario: str, run_id: str, *, outcome: str = "pass", adapter: str = "v3", scenario_version: str = "v1", bundle_digest: str | None = None, observations: list[str] | None = None, receipt_id: str | None = None) -> Path:
