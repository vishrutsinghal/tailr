...
class EvaluationHarnessScenarioTests(unittest.TestCase):
    ...
    def test_scenario_list_shows_committed_scenarios(self) -> None:
        ...
        self.assertEqual(
            scenario_ids,
            {"validation-bug", "dependency-decision", "review-only", "ci-failure", "security-triage", "buildweek-validation", "higher-tier-release-confidence", "spec-kit-closure", "interactive-plan-mode", "dwr-small-change-vertical"},
        )
    ...
    def test_all_scenarios_pass_expected_thresholds(self) -> None:
        scenarios = ["validation-bug", "dependency-decision", "review-only", "ci-failure", "security-triage", "buildweek-validation", "spec-kit-closure", "interactive-plan-mode", "dwr-small-change-vertical"]
