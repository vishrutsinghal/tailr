...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_each_new_contract_validates_a_real_example(self) -> None:
        examples = [
            ...
            {"schema_version":"1","type":"tailtrail-workflow-context-receipt","workflow_id":"ttw-contract","stage_id":"focused-test","selected_refs":[".tailtrail/context/validation.json"],"avoided_categories":["unrelated-docs"],"exactness":"must-be-exact","token_posture":"estimated","context_budget_tokens":100,"reduction_status":"not-requested","retrieval_refs":[],"receipt_fingerprint":"sha256:context","boundary":"Compact context reference only."},
