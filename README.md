...
If you only want portable project guidance, copy `AGENTS.md` into the root of the target project. If you want skill invocation with `@tailtrail` and `@tailtrail-review`, use the plugin package in this repo.
