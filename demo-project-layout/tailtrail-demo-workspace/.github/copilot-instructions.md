...
TailTrail support files are installed under `tailtrail`.
...
- `tailtrail/GOVERNANCE.md`
- `tailtrail/tailtrail-policy.example.md`
- `tailtrail/context/flow-catalog.md`
- `tailtrail/context/guardrail-layers.md`
- `tailtrail/context/intent-aliases.md`
- `tailtrail/context/navigator.md`
- `tailtrail/context/code-graph-mapper.md`
- `tailtrail/context/review-lenses.md`
- `tailtrail/context/TailTrail.map.md`
- `tailtrail/context/slices.md`
- `tailtrail/TAILTRAIL-COMMANDS.md`
- `tailtrail/USEFUL-PROMPTS.md`
- `tailtrail/hooks/`
- `tailtrail/benchmarks/`
- `tailtrail/aidlc/stages/`
- `tailtrail/templates/`

When scripts are needed, use:

- `python3 tailtrail/scripts/tailtrail.py help`
- `python3 tailtrail/scripts/tailtrail.py guide "fix Sonar issue and prepare PR"`
- `python3 tailtrail/scripts/navigator.py "fix Sonar issue and prepare PR"`
- `python3 tailtrail/scripts/tailtrail.py graph --changed path/to/file`
- `python3 tailtrail/scripts/tailtrail.py graph map --changed path/to/file`
- `python3 tailtrail/scripts/tailtrail.py graph status --changed path/to/file`
- `python3 tailtrail/scripts/tailtrail.py ci summarize --file ci.log`
- `python3 tailtrail/scripts/tailtrail.py sonar summarize --file sonar.log`
- `python3 tailtrail/scripts/tailtrail.py validation summarize --ci ci.log --sonar sonar.log`
- `python3 tailtrail/scripts/tailtrail.py quality scan --changed path/to/file`
- `python3 tailtrail/scripts/tailtrail.py quality run --approved --command "npm run lint"`
- `python3 tailtrail/scripts/tailtrail.py quality-loop review --month 2026-07`
- `python3 tailtrail/scripts/tailtrail.py report --month 2026-07`
- `python3 tailtrail/scripts/tailtrail.py report value --month 2026-07`
- `python3 tailtrail/scripts/tailtrail.py policy check --root .`
- `python3 tailtrail/scripts/tailtrail.py governance check`
- `python3 tailtrail/scripts/tailtrail.py vulnerability scan --changed package.json`
- `python3 tailtrail/scripts/tailtrail.py vulnerability summarize --file audit.log`
- `python3 tailtrail/scripts/tailtrail.py vulnerability run --approved --command "npm audit"`
- `python3 tailtrail/scripts/expand-intent.py "use AIDLC and review"`
- `python3 tailtrail/scripts/install-local.py --inspect`
- `python3 tailtrail/scripts/benchmark-tailtrail.py`
- `python3 tailtrail/scripts/analyze-benchmark.py tailtrail/benchmarks/results/latest.json`
- `python3 tailtrail/scripts/team-init.py --root . --mode optional`
- `python3 tailtrail/scripts/learnings.py init --root .`
- `python3 tailtrail/scripts/learning-agent.py search --tags sonar,java --limit 3`
- `python3 tailtrail/scripts/learning-refresh.py recommend --root .`
- `python3 tailtrail/scripts/graph-learning.py search --changed path/to/file --tags sonar,java`
- `python3 tailtrail/hooks/learning-capture-hook.py "Fixed validator complexity" --candidate "Extract named guard methods while preserving validation order."`
- `python3 tailtrail/scripts/review-graph.py --changed path/to/file`
- `python3 tailtrail/scripts/code-graph-mapper.py map --changed path/to/file`
- `python3 tailtrail/scripts/token-auto.py "review this diff"`
- `python3 tailtrail/scripts/token-savings.py estimate --used tailtrail/context/slices.md --avoided tailtrail/ROADMAP.md tailtrail/USER-GUIDE.md`
- `python3 tailtrail/scripts/route-context.py review`
- `python3 tailtrail/scripts/aidlc-init.py --root . --depth standard`
- `python3 tailtrail/scripts/aidlc-check.py --root .`
