...
Then summarize the generated `.tailtrail/code-graph-cache.json` at a high level. Do not edit code.
```
...
```text
Code Graph Mapper
- Cache: .tailtrail/code-graph-cache.json
...
Used context: README.md, context/code-graph-mapper.md, .tailtrail/code-graph-cache.json
