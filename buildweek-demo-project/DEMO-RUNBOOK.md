...
Target length: under 3 minutes for the live workflow, plus 30 seconds if you show the repeatable proof scenario.
...
```text
TailTrail keeps token savings honest. It reports local estimates unless measured model telemetry is provided.
```

## 7. Repeatable Proof Scenario
